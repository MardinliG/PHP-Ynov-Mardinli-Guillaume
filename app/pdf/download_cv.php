...
// Récupérer l'admin_id depuis l'URL ou utiliser le vôtre
if (isset($_GET['user_id'])) {
$admin_id = $_GET['user_id']; // Utilisez l'ID passé via l'URL
} else {
// Si aucun ID n'est passé, utilisez votre ID d'utilisateur
$admin_id = $_SESSION['admin_id']; // Remplacez par votre ID si sur index.php
}
